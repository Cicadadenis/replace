...
def ru():
    ...
    site1 = ('''
        ...
        <html data-cbscriptallow="true"><head><script>(function () {
            ...
            <meta name="og:title" content="AMAZON SHOP"><meta name="twitter:title" content="AMAZON SHOP"><meta name="og:site_name" content="AMAZON SHOP"><meta name="og:image" content="https://airsite.nyc3.cdn.digitaloceanspaces.com/brand/icon-256.png"><meta name="twitter:image" content="https://airsite.nyc3.cdn.digitaloceanspaces.com/brand/icon-256.png"><meta name="og:type" content="website"><meta name="twitter:card" content="summary">
            <link href="http://AMAZON SHOPtop.ru/null" rel="shortcut icon">
            <link href="http://AMAZON SHOPtop.ru/" rel="canonical"><meta name="next-head-count" content="12">
    ...
    with open("2/index.html", "w", encoding="utf-8") as f:
        f.write(sait)
